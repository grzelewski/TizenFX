...
namespace Tizen.NUI
{
    public class VoidToVoidSignal : Disposable
    {
        public VoidToVoidSignal(global::System.IntPtr cPtr, bool cMemoryOwn) : base(cPtr, cMemoryOwn)
        {
        }
        ...
        public VoidToVoidSignal() : this(Interop.VoidSignal.new_VoidSignal(), true)
        {
